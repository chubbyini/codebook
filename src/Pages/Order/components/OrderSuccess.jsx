  ...
  return (
    <section className="text-xl text-center max-w-4xl mx-auto my-10 py-5 dark:text-slate-100 border dark:border-slate-700 rounded">
        ...
        <div className="my-5">
            ...
            <span>
              <p className="my-5">{Math.round(Math.random()*100000000000)}</p>
            
            </span>
            <p className="text-sm text-gray-500">This is your unique order number, please keep it safe for future reference.</p>
        </div>
